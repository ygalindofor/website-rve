            ...
            <div class="card card-3">
                ...
                <div class="card-body">
                    <h2 class="title">Ingresar información</h2>
										<form class="contacto"	 action="registroprof.php" method="POST" onsubmit='return validar()'>
										...
										<div class="text-danger" id="msg-email2">ejemplo ashd@dfg.xy</div><br>
											...
											<div class="input-group">
	  										<div><input class="input--style-3" id="pass_coor" type="password" name="txtpass_prof" placeholder="Ingresar Contraseña" ></div>
											</div>
