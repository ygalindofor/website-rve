    ...
    <div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins">
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
                ...
                <div class="card-body">
                    <h2 class="title">Ingresar información del estudiante</h2>
										<form class="contacto"	 action="Registro.php" method="POST" onsubmit='return validar()'>
											<div class="input-group">
											<div><input  class="input--style-3" id="cedula"class="codigo" type="text" name="txtcodigo" placeholder="Ingresar numero tarjeta" maxlength="10" >
											</div>
										</div>
										<div class="text-danger" id="msg-cedula">Ingrese numero tarjeta <br></div>
										...
										<div class="text-danger" id="msg-nombre2">Ingrese la primera letra en mayúscula</div><br>
										<div class="input-group">
